...
const NOT_A_BRAND = new Set(['odg', 'onlinedivegear com au', 'onlinedivegear', 'online dive gear', 'dive swansea', 'diveswansea', 'adventure underwater products',
  ...
  'scuba dive shop', 'scubadiveshop', 'scubadiveshop com au', 'scuba culture', 'dive centre bondi', 'dive center bondi', 'dive gear australia', 'divegearaustralia', 'my dive gear', 'mydivegear', 'infinity dive', 'infinitydive',
  'extreme watersport', 'extreme watersport shop', 'extremewatersportshop', 'my store', 'gold coast dive adventures', 'gcda',
